...
**Test suite:** **1,343 tests** (1,342 passing + 1 failing `test_count_variable` = P48.14 in `akar-main/tests/repro_multihop.rs`, 5 ignored doc-tests). **25 optimizer passes**, **37 logical types**, **58 logical operators**, **49 physical operator structs**.
