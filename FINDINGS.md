...
P124.1–P124.2 di akar, P4-RETIRE-1/P4-BOUND-1 di sulur), F10 (seluruh 5 primitif
yang diadopsi: P119 decay Ebbinghaus, P120 embedding lokal, P121 hierarchical RRF +
authority multiplier, P122 `akar-markdown`), dan **F15 (default `checkpoint_threshold` → 16 MiB:
P128.2)** — semuanya sudah ditutup dan dipindah ke
