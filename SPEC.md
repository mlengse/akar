...
| Tests passing | **1,349 total, all passing** (P48.14 `test_count_variable` fixed 2026-08-07), 5 ignored (doc-tests) |
...
| `akar-main` (integration) | 287 | RETURN *, FOREACH, MERGE, subqueries, WCOJ, crash recovery, durability |
...
| **Total** | **1,349** | **1,349 passed, 0 failed (P48.14 `test_count_variable` fixed), 5 ignored (doc-tests)** |
