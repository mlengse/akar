...
| Tests passing | **1,943 total, 0 ignored, 1,943 passed, 0 failed** (gate `test [akar-core]` 2026-08-30, s.d. P79 batch 2; P71 vector tests are feature-gated) |
...
| **Total** | **1,943** | **1,943 total, 0 ignored, 1,943 passed, 0 failed** (gate `test [akar-core]` 2026-08-30, s.d. P79 batch 2; P71 vector tests are feature-gated) |
