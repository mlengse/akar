...
| Tests passing | **1,901 total, 0 ignored, 1,901 passed, 0 failed** (gate `test [akar-core]` 2026-08-26, s.d. P65 array params) |
...
| **Total** | **1,901** | **1,901 total, 0 ignored, 1,901 passed, 0 failed** (gate `test [akar-core]` 2026-08-26, s.d. P65 array params) |
