...
| Tests passing | **2,114** total, 0 ignored, 2,114 passed, 0 failed (gate `test [akar-core]`, 2026-09-20, P125: +7 tes — `CASE` pada daftar proyeksi tidak lagi mengembalikan kolom yang salah/F12). Riwayat delta per-task P### tercantum di CHANGELOG.md — kolom ini mencatat status terkini saja. |
