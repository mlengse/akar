...
| Tests passing | **1,918 total, 0 ignored, 1,918 passed, 0 failed** (gate `test [akar-core]` 2026-08-29, s.d. P73.1; P71 vector tests are feature-gated) |
...
| `akar-server` | 29 | TCP framing, session, concurrency, auth/idle/stats (P62), parameter binding (P64) |
...
| **Total** | **1,918** | **1,918 total, 0 ignored, 1,918 passed, 0 failed** (gate `test [akar-core]` 2026-08-29, s.d. P73.1; P71 vector tests are feature-gated) |
