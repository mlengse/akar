...
| Tests passing | **1,945 total, 0 ignored, 1,945 passed, 0 failed** (gate `test [akar-core]` 2026-08-30, s.d. P79 batch 3 CSV null_str; P71 vector tests are feature-gated) |
...
| **Total** | **1,945** | **1,945 total, 0 ignored, 1,945 passed, 0 failed** (gate `test [akar-core]` 2026-08-30, s.d. P79 batch 3 CSV null_str; P71 vector tests are feature-gated) |
