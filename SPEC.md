...
| Tests passing | **1,925 total, 0 ignored, 1,925 passed, 0 failed** (gate `test [akar-core]` 2026-08-30, s.d. P74; P71 vector tests are feature-gated) |
...
| **Total** | **1,925** | **1,925 total, 0 ignored, 1,925 passed, 0 failed** (gate `test [akar-core]` 2026-08-30, s.d. P74; P71 vector tests are feature-gated) |
