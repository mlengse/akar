...
| Tests passing | **1,918 total, 0 ignored, 1,918 passed, 0 failed** (gate `test [akar-core]` 2026-08-29, s.d. P73.2; P71 vector tests are feature-gated) |
...
| **Total** | **1,918** | **1,918 total, 0 ignored, 1,918 passed, 0 failed** (gate `test [akar-core]` 2026-08-29, s.d. P73.2; P71 vector tests are feature-gated) |
