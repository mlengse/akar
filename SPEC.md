...
| Tests passing | **1,947 total, 0 ignored, 1,947 passed, 0 failed** (gate `test [akar-core]` 2026-08-30, s.d. P79 batch 4 rng bias; P71 vector tests are feature-gated) |
...
| **Total** | **1,947** | **1,947 total, 0 ignored, 1,947 passed, 0 failed** (gate `test [akar-core]` 2026-08-30, s.d. P79 batch 4 rng bias; P71 vector tests are feature-gated) |
