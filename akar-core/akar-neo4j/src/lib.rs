//! Neo4j migration extension for Akar.
//!
//! Provides the `NEO4J_MIGRATE` table function that parses a Neo4j
//! Cypher dump file and migrates the schema and data into Akar.
//!
//! Supported Neo4j dump constructs:
//! - `CREATE CONSTRAINT` — mapped to Akar PRIMARY KEY
//! - `CREATE INDEX` — noted (Akar auto-indexes PKs)
...
/// In a real execution, this would interact with the Akar catalog
