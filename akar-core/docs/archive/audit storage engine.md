...
## Comprehensive Audit of `akar-storage` Crate

### Objective
Audit the complete Rust storage crate at `C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage` (30 source files). For each component, evaluate implementation completeness, identify `todo!()` / `unimplemented!()` calls, flag simplifications versus the C++ originals, and document missing features.
...
### Relevant Files
- **C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\lib.rs** — Module declarations, `StorageManager`, re-exports, ~25k-line integration test suite
- **C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\wal.rs** — Full WAL with all record types
- **C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\local_wal.rs** — Per-txn WAL buffer, bulk-copy on commit
- **C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\undo_buffer.rs** — Undo records for rollback
- **C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\free_space_manager.rs** — Buddy-system free space tracker
- **C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\page_manager.rs** — Page allocator wrapping FSM + file extension
- **C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\buffer_manager.rs** — Buffer pool with Clock eviction (known limitations doc-commented)
- **C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\column.rs** — Page-based column store with tag-byte serialization
- **C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\column_chunk.rs** — `Vec<Value>` buffer, `to_arrow()` returns error
- **C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\compression.rs** — Per-type compress/decompress, StringDict is pass-through
- **C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\table.rs** — NodeTable, RelTable (flat Vec<RelData>), TableCatalog
- **C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\node_group.rs** — In-memory NodeGroup with flush/s pill
- **C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\csr.rs** — **STUB**: empty neighbors, no-op add_edge
- **C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\wal_replayer.rs** — Callback-based WAL replay
- **C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\checkpoint.rs** — Flush WAL + dirty pages + marker; `flush_table()` no-op
- **C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\index.rs** — Two-layer hash index (L1+L2)
- **C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\art_index.rs** — Full ART with persistence and prefix range scan
- **C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\art_key.rs** — Order-preserving byte encoding
- **C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\art_node.rs** — Node4/16/48/256 with serialization
- **C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\local_storage.rs** — Per-txn write buffer with serialized blobs
- **C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\shadow_file.rs** — In-memory shadow overlay
- **C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\page.rs** — Frame with pin/dirty/clock_ref, FileHandle
- **C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\lazy_scanner.rs** — NodeGroup-at-a-time scanner
- **C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\predicate.rs** — Zone-map filtering
- **C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\ice_format.rs** — Parquet-based IceDiskRelTable
- **C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\version_info.rs** — Per-vector txn insert/delete tracking
- **C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\update_info.rs** — Version chain linked list
- **C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\roaring_bitmap.rs** — Array+Bitmap containers, no Run, no serde
- **C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\stats.rs** — In-memory stats, no persistence
- **C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\hyperloglog.rs** — HLL P=6, 64 registers
- **C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\vector_index.rs** — HNSW vector index with persistence
- **C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\spiller.rs** — JSON-lines spill + multi-way merge
- **C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\csv_reader.rs** — CSV bulk reader (not audited in detail)
- **C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\npy_reader.rs** — NPY array reader (not audited in detail)
- **C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\parquet_reader.rs** — Parquet reader (feature-gated, not audited)
- **C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\parquet_writer.rs** — Parquet writer (feature-gated, not audited)
