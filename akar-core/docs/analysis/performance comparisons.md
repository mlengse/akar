...
- `C:\Users\anjan\dev\memory\kuzu\akar-core\akar-processor\benches\physical_scan.rs` -- Scan throughput benchmarks
- `C:\Users\anjan\dev\memory\kuzu\akar-core\akar-processor\benches\physical_filter.rs` -- Filter throughput (Arrow-native)
- `C:\Users\anjan\dev\memory\kuzu\akar-core\akar-processor\benches\physical_hash_join.rs` -- Hash join benchmarks
- `C:\Users\anjan\dev\memory\kuzu\akar-core\akar-processor\benches\physical_order_by.rs` -- Order by benchmarks
- `C:\Users\anjan\dev\memory\kuzu\akar-core\akar-processor\benches\physical_aggregate.rs` -- Aggregate benchmarks
- `C:\Users\anjan\dev\memory\kuzu\akar-core\akar-processor\benches\evaluate_arrow.rs` -- Arrow-native vs per-row eval comparison
- `C:\Users\anjan\dev\memory\kuzu\akar-core\akar-main\benches\query_pipeline.rs` -- End-to-end SQL pipeline (includes C++ comparison)
- `C:\Users\anjan\dev\memory\kuzu\akar-core\akar-main\benches\storage_bench.rs` -- Storage benchmarks
- `C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\benches\hybrid_eval.rs` -- Hybrid evaluation benchmarks

**Performance data/output files:**
- `C:\Users\anjan\dev\memory\kuzu\akar-core\rust_bench.txt` -- **Empty file** (placeholder for Rust benchmark results)
- `C:\Users\anjan\dev\memory\kuzu\cpp_bench.json` -- **Binary file** (JSON output from C++ benchmark binary)

**Performance documentation:**
- `C:\Users\anjan\dev\memory\kuzu\akar-core\BENCHMARK_COMPARISON.md` -- **Main Rust vs C++ comparison document** (504 lines, comprehensive)
- `C:\Users\anjan\dev\memory\kuzu\akar-core\implementation_plan.md` -- Contains P26.4 Performance Profiling section
- `C:\Users\anjan\dev\memory\kuzu\akar-core\STATUS.md` -- Comprehensive status including performance metrics
...
- `C:\Users\anjan\dev\memory\kuzu\akar-core\BENCHMARK_COMPARISON.md` -- **Primary comparison document** with extensive performance numbers for Rust vs C++ across scan, filter, hash join, order by, aggregate, and expression evaluation. Key finding: Rust reached **C++ parity** (397 us vs 400 us) on the filter+COUNT benchmark.
- `C:\Users\anjan\dev\memory\kuzu\akar-core\implementation_plan.md` -- Contains **P26.4 Performance Profiling Report** with 8 benchmark suite results including scan (3.5-6.3x faster than old baseline), filter (Arrow-native 17-122x speedup), hash join (7.5-11.8x faster), order by, aggregate, and expression evaluation data.
- `C:\Users\anjan\dev\memory\kuzu\akar-core\STATUS.md` -- Contains performance summary metrics including the 4.5x gap closure timeline and operator-level breakdown.
- `C:\Users\anjan\dev\memory\kuzu\akar-core\rust_bench.txt` -- **Empty file** (placeholder)
...
**"Port of C++" references in Rust akar-core:**
- `C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\art_node.rs` -- "Port of C++ `ArtPrimaryKeyIndex::Node`"
- `C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\art_key.rs` -- "Port of C++ `ArtKey` from `ladybug/src/storage/index/art_index.cpp`"
- `C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\art_index.rs` -- "Port of C++ `ArtPrimaryKeyIndex`" (multiple porting references throughout)
- `C:\Users\anjan\dev\memory\kuzu\akar-core\akar-function\src\registry.rs` -- "Hash functions -- ported from C++", "Interval constructor functions -- ported from C++"
- `C:\Users\anjan\dev\memory\kuzu\akar-core\akar-planner\src\logical_operator.rs` -- "Simplified Rust port of C++ `LogicalSemiMasker`"
- `C:\Users\anjan\dev\memory\kuzu\akar-core\akar-processor\src\physical\write_ops\recursiveextend.rs` -- "port of C++ `WeightedSPPathsFunction`"
...
- `C:\Users\anjan\dev\memory\kuzu\akar-core\akar-main\tests\test_proptest.rs` -- Three proptest properties:
...
**serde / serde_json:**
- Used extensively throughout `akar-core`:
  - `C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\Cargo.toml` -- `serde` and `serde_json` dependencies
  - `C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\spiller.rs` -- Uses `serde_json` for spill-to-disk serialization
  - `C:\Users\anjan\dev\memory\kuzu\akar-core\akar-storage\src\column_chunk.rs` -- Uses `serde_json` for "simple portable binary representation"
  - `C:\Users\anjan\dev\memory\kuzu\akar-core\akar-json\src\lib.rs` -- JSON type handling with `serde_json::Value`
  - `C:\Users\anjan\dev\memory\kuzu\akar-core\akar-llm\src\lib.rs` -- LLM extension uses `serde_json` for API calls
  - `C:\Users\anjan\dev\memory\kuzu\akar-core\akar-wasm\Cargo.toml` -- `serde-wasm-bindgen` for WASM bindings
  - `C:\Users\anjan\dev\memory\kuzu\akar-core\akar-migrate\src\main.rs` -- Uses `serde_json::Value` for schema migration
...
**flatbuffers:**
- Referenced in `Cargo.lock` files across the Rust workspace (`akar-core/Cargo.lock`, `tools/rust_api/Cargo.lock`, `akar-core/fuzz/Cargo.lock`, `examples/rust/Cargo.lock`)
...
**Property-based equivalence (akar-core Rust port):**
- `C:\Users\anjan\dev\memory\kuzu\akar-core\akar-main\tests\test_proptest.rs` -- Three properties testing correctness across the full pipeline

**End-to-end benchmark comparison:**
- `C:\Users\anjan\dev\memory\kuzu\akar-core\akar-main\benches\query_pipeline.rs` -- benchmark `bench_query_filter_count_10k_vs_cpp` directly compares Rust `conn.execute()` against C++ `kuzu_benchmark.exe` using identical SQL queries and datasets
...
- `C:\Users\anjan\dev\memory\kuzu\akar-core\STATUS.md` (Section 8, lines 669-812) -- Comprehensive per-layer comparison of Rust `akar-core` vs C++ LadybugDB:
  - **Overall parity: ~88%**
...
4. **LadybugDB C++ submodule** at `ladybug/` is the reference implementation; the `akar-core/` Rust port targets full parity
