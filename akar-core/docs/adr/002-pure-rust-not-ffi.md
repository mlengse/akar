...
- 32 crate, 1,535 test (all passing — P48.14 `test_count_variable` + P48.15 NaN ordering fixed, P48.16 dead SIP semi-masker removed, P48.17 node-predicate + WHERE AND-combined per 2026-08-07/08), 24 optimizer passes
