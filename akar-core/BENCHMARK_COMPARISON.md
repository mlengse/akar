...
**Result:** SUM/AVG/MIN/MAX now at parity with COUNT (~1.6× ratio in debug, estimated parity in release). Workspace green (1,346 tests: 1,345 passing + 1 failing `test_count_variable` = P48.14).
