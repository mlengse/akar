...
- **Test suite:** 1,890 total / 0 ignored / 1,890 passed / 0 failed (gate `test [akar-core]`, 2026-08-25)
...
- **GDS:** 18 graph algorithms (BFS, Dijkstra, PageRank, WCC, SCC, K-Core, Louvain, node2vec, ...)
