...
| `akar-main` (integration) | 293 | ✅ | RETURN *, FOREACH, MERGE, subqueries, WCOJ, crash recovery, durability, server mode (P48.14 `test_count_variable` fixed; P48.15 NaN ordering tests; P48.16 dead SIP test removed; P48.17 node-predicate + WHERE tests ×3) |
