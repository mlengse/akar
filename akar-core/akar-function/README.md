...
**Registered functions (259):** 244 scalar + 14 aggregate + 1 table. Includes arithmetic,
comparison, boolean, string, date/time, cast, list, map, struct, array, path,
schema/utility, and 14 aggregates.
