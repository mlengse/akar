...
use arrow::array::{
    ArrayRef, Float32Builder, Float64Builder, Int8Builder, Int16Builder, Int32Builder, Int64Builder, PrimitiveArray,
    UInt8Builder, UInt16Builder, UInt32Builder, UInt64Builder,
};
use arrow::compute;
use arrow::datatypes::{
    Float32Type, Float64Type, Int8Type, Int16Type, Int32Type, Int64Type, UInt8Type, UInt16Type, UInt32Type, UInt64Type,
};
use std::sync::Arc;
...
impl AggValueState {
    ...
    pub fn update(&mut self, val: &Value) {
        ...
        match self {
            ...
            AggValueState::StringAgg { pieces, .. } => match val {
