...
**Yang masih kurang:** ~~On-disk HashIndex~~ ✅ (A1), ~~WAL recovery on startup~~ ✅ (A2), ~~Auto-checkpoint wiring~~ ✅ (A3), ~~ShadowFile+LocalStorage→Commit~~ ✅ (A4), ~~HNSW Vector Index~~ ✅ (A5), CLI polish (history, auto-complete, multi-line), Benchmarks, tools/rust_api integration, CI/CD, C++ cleanup.
