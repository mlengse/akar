...
tools: [vscode, execute, read, agent, ms-vscode.cpp-devtools, ms-vscode.cpptools, the0807.uv-toolkit, edit, search, web, 'github/*', 'memory/*', 'playwright/*', 'rust-analyzer/*', 'sequentialthinking/*', browser, todo]
user-invocable: true
---
