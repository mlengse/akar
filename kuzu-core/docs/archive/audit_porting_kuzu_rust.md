...
|-----------|:--------:|:-----------:|:----:|--------|
| JSON | ✅ | ✅ | ✅ `kuzu-json` | ✅ Native |
| FTS | ✅ | ✅ | ✅ `kuzu-fts` | ✅ Native (BM25) |
| HTTPFS | ✅ | ✅ | ✅ `kuzu-httpfs` | ✅ Native |
| DuckDB | ✅ | ✅ | ✅ `kuzu-duckdb` | ✅ |
| PostgreSQL | ✅ | ✅ | ✅ `kuzu-postgres` | ✅ |
| SQLite | ✅ | ✅ | ✅ `kuzu-sqlite` | ✅ Native |
| Neo4j | ✅ | ✅ | ✅ `kuzu-neo4j` | ✅ Native |
| Delta Lake | ✅ | ✅ | ✅ `kuzu-delta` | ✅ Native |
| Iceberg | ✅ | ✅ | ✅ `kuzu-iceberg` | ✅ Native |
| Azure | ✅ | ✅ | ✅ `kuzu-azure` | ✅ Native |
| Unity Catalog | ✅ | ✅ | ✅ `kuzu-unity-catalog` | ✅ Native |
| LLM | ✅ | ✅ | ✅ `kuzu-llm` | ✅ |
| Vector | ✅ | ✅ | ✅ `kuzu-vector` | ✅ |
| WASM | ❌ | ❌ | ✅ `kuzu-wasm` | ✅ **Rust-only** |
| Migrate | ❌ | ❌ | ✅ `kuzu-migrate` | ✅ **Rust-only** |
...
| **WASM target** | `kuzu-wasm` crate | N/A |
