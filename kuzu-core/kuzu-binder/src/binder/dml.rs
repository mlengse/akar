...
impl Binder {
    ...
    pub(crate) fn bind_unwind(&self, u: &kuzu_parser::ast::UnwindClause) -> Result<BoundUnwindClause, String> {
    ...
    pub(crate) fn bind_set(&self, s: &kuzu_parser::ast::SetClause, variables: &[BoundVariable]) -> Result<BoundSetClause, String> {
    ...
    pub(crate) fn bind_union(&self, u: kuzu_parser::ast::UnionStatement) -> Result<BoundStatement, String> {
    ...
    pub(crate) fn bind_merge(&self, m: kuzu_parser::ast::MergeStatement) -> Result<BoundStatement, String> {
