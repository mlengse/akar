...
impl Connection {
    ...
    fn execute_export_database(&self, e: &BoundExportDatabase) -> Result<Option<QueryResult>, String> {
        use std::fs;
        use std::path::Path;
    ...
    fn execute_import_database(&self, i: &BoundImportDatabase) -> Result<Option<QueryResult>, String> {
