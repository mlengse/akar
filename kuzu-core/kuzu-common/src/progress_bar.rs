...
/// A thin wrapper around `indicatif::ProgressBar` for Kuzu operations.
///
...
///
/// ```no_run
/// use kuzu_common::progress_bar::KuzuProgress;
///
/// let pb = KuzuProgress::new("Loading data…", Some(1000));
/// for i in 0..1000 {
///     pb.inc();
